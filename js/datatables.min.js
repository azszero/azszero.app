 ...
 *   https://datatables.net/download/#dt/dt-1.10.18/fc-3.2.5/fh-3.1.4/r-2.2.2/rg-1.1.0
 *
 * Included libraries:
 *   DataTables 1.10.18, FixedColumns 3.2.5, FixedHeader 3.1.4, Responsive 2.2.2, RowGroup 1.1.0
 */
...
(function (c) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function (d) { return c(d, window, document) }) : "object" === typeof exports ? module.exports = function (d, h) { d || (d = window); if (!h || !h.fn.dataTable) h = require("datatables.net")(d, h).$; return c(h, d, d.document) } : c(jQuery, window, document) })(function (c, d, h, k) {
    ...
    }); e.defaults = { className: "dtrg-group", dataSrc: 0, emptyDataGroup: "No group", enable: !0, endClassName: "dtrg-end", endRender: null, startClassName: "dtrg-start", startRender: function (a, b) { return b } }; e.version = "1.1.1-dev"; c.fn.dataTable.RowGroup = e; c.fn.DataTable.RowGroup =
